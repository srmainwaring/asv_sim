...
namespace asv
{
  ...
  */
  ...
  /// \brief Template function specialisation for setting a value in parameter message.
  /// \param[out] _param Parameter message to set.
  ...
  /// \brief Template function specialisation for setting a value in parameter message.
  /// \param[out] _param Parameter message to set.
  /// \param[in] _value A ignition::math::Vector3d value to store in the parameter message.
  template <>
  void MsgParamSetValue<ignition::math::Vector3d>(gazebo::msgs::Param& _param, const ignition::math::Vector3d& _value);
