...
#include "asv_sim_gazebo_plugins/GazeboRosAnemometer.h"
...
namespace asv
{
    ...
    void GazeboRosAnemometer::Load(gazebo::sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
    {
        ...
        if (!sensor_)
        {
            gzthrow("GazeboRosAnemometer requires a Anemometer Sensor as its parent");
            return;
        }
