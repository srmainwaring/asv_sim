...
#ifndef ASV_SIM_WINCH_HH_
#define ASV_SIM_WINCH_HH_
...
/// \brief A plugin that simulates a winch.
class Winch
    : public System,
      ...
      public ISystemPreUpdate
{
  ...
  private: std::unique_ptr<WinchPrivate> dataPtr;
};
